...
| Folder                    | Description                                                                                                                              |
| ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| `agents/mastra`           | Entry point for all Mastra-related code and configuration.                                                                               |
| `agents/mastra/agents`    | Define and configure your agents - their behavior, goals, and tools.                                                                     |
| `agents/mastra/workflows` | Define multi-step workflows that orchestrate agents and tools together.                                                                  |
| `agents/mastra/tools`     | Create reusable tools that your agents can call                                                                                          |
| `agents/mastra/mcp`       | (Optional) Implement custom MCP servers to share your tools with external agents                                                         |
| `agents/mastra/scorers`   | (Optional) Define scorers for evaluating agent performance over time                                                                     |
| `agents/mastra/public`    | (Optional) Contents are copied into the `.build/output` directory during the build process, making them available for serving at runtime |
...
| File                     | Description                                                                                                       |
| ------------------------ | ----------------------------------------------------------------------------------------------------------------- |
| `agents/mastra/index.ts` | Central entry point where you configure and initialize Mastra.                                                    |
